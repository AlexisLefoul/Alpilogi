...
import { VStack, Avatar, AvatarImage, HStack } from "@gluestack-ui/themed";
          ...
          >
            <HStack space="lg" style={styles.bot}>
              <Text style={styles.sousTitle}>
                Réaliser la feuille de soin de ce patient
              </Text>
              <View>
          ...
          <TouchableOpacity
            onPress={() =>
              navigation.navigate("HistoryTreatmentSheets", {
                patientId: patient.id,
                patientName: patient.name + " " + patient.lname,
              })
            }
          >
            <HStack space="lg" style={styles.bot}>
              <Text style={styles.sousTitle}>
                Voir les feuilles de soin de ce patient
              </Text>
              <View>
                <Icon name="chevron-right" size={50} color={Color.bleu1} />
              </View>
